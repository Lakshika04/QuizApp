        ...
        <div className={signupStyles.animatedBorder}>
            <div className={signupStyles.formContent}>
                ...
                <label className={signupStyles.label}>
                    ...
                    <div className={signupStyles.inputContainer}>
                        <span className={signupStyles.inputIcon}>
                            <Mail className={signupStyles.inputContainer}/>
                        </span>
                  ...
                  <label className={signupStyles.label}>
                    ...
                    <div className={signupStyles.inputContainer}>
                        <span className={signupStyles.inputIcon}>
                            <Lock className={signupStyles.inputContainer}/>
                        </span>
                    ...
                    <button type="button" className={signupStyles.passwordToggle} onClick={() => setShowPassword((prev) => !prev)}>
                      {showPassword ? (
